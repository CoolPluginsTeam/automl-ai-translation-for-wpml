...
export const updateTranslateData = ({ provider, sourceLang, targetLang, parentPostId, currentPostId, editorType, updateTranslateDataNonce, extraData = {} }) => {
    ...
    const data = { provider, totalStringCount, totalWordCount, totalCharacterCount, editorType, date, sourceStringCount, sourceWordCount, sourceCharacterCount, sourceLang, targetLang, timeTaken, action: atfpp_bulk_translate_object.update_translate_data, atfp_nonce: updateTranslateDataNonce, post_id: currentPostId, ajax_url: atfpp_bulk_translate_object.ajax_url, extraData: JSON.stringify(extraData), bulk_translate: true };
