...
export default (props) => {
    ...
    const Services = {
        localAiTranslator: {
            ...
            ErrorMessage: props.localAiTranslatorButtonDisabled ? <div className={`${prefix}-provider-error button button-primary`} onClick={() => openErrorModalHandler(props.localAiTranslatorButtonDisabled)}><img src={errorIcon} alt="error" /> {__('View Error', 'automl-ai-translation-for-wpml')}</div> : <></>,
            Logo: 'chrome.png',
        ...
        openai_ai: {
            ...
            ErrorMessage: props.openai_aiButtonDisabled ? <a className={`${prefix}-provider-error button button-primary`} href={adminUrl + 'admin.php?page=polylang-automl-wpml-dashboard&tab=settings'} target="_blank"><img src={errorIcon} alt="error" /> {__('Add API Key', 'automl-ai-translation-for-wpml')}</a> : <></>,
            Logo: 'openai.png',
            filterHtmlContent: true
        },
        google_ai: {
            ...
            ErrorMessage: props.google_aiButtonDisabled ? <a className={`${prefix}-provider-error button button-primary`} href={adminUrl + 'admin.php?page=polylang-automl-wpml-dashboard&tab=settings'} target="_blank"><img src={errorIcon} alt="error" /> {__('Add API Key', 'automl-ai-translation-for-wpml')}</a> : <></>,
            Logo: 'gemini.png',
            filterHtmlContent: true
        }
    };
