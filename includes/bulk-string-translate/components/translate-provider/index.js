...
export default (props) => {
    ...
    const Services = {
        ...
        openai_ai: {
            ...
            ErrorMessage: props.openai_aiButtonDisabled ? <a className={`${prefix}-provider-error button button-primary`} href={adminUrl + 'admin.php?page=polylang-automl-wpml-dashboard&tab=settings'} target="_blank"><img src={errorIcon} alt="error" /> {__('Add API Key', 'autopoly-ai-translation-for-polylang-pro')}</a> : <></>,
            Logo: 'openai.png',
            filterHtmlContent: true
        },
        google_ai: {
            ...
            ErrorMessage: props.google_aiButtonDisabled ? <a className={`${prefix}-provider-error button button-primary`} href={adminUrl + 'admin.php?page=polylang-automl-wpml-dashboard&tab=settings'} target="_blank"><img src={errorIcon} alt="error" /> {__('Add API Key', 'autopoly-ai-translation-for-polylang-pro')}</a> : <></>,
            Logo: 'gemini.png',
            filterHtmlContent: true
        }
    };
