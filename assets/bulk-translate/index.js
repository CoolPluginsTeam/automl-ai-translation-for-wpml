...
const App = ({
  ...
  const [errorMessage, setErrorMessage] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(postIds.length === 0 ? emptyPostIdsErrorMessage : '');
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsxs)("div", {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsxs)("div", {
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)("button", {
            ...
            title: !postIds.length ? emptyPostIdsErrorMessage : !selectedLanguages.length ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Please select at least one language', 'automl-ai-translation-for-wpml') : '',
      ...
      if (languages && languages.length > 0) {
        ...
        if (editor_type === 'block') {
          ...
          if (!storeParseBlockRules) {
            storeDispatch((0,_redux_store_features_actions__WEBPACK_IMPORTED_MODULE_1__.updateBlockParseRules)(JSON.parse(untranslatedPostsData?.data?.blockParseRules)));
        ...
        storeDispatch((0,_redux_store_features_actions__WEBPACK_IMPORTED_MODULE_1__.updateCountInfo)({
          totalPosts: _redux_store_store__WEBPACK_IMPORTED_MODULE_2__.store.getState().countInfo.totalPosts + targetLang.length
        }));
      } else {
        console.log(`All target languages for post ${postId} already exist. Skipping translation.`);
      }
...
/***/ "./assets/src/bulk-translate/components/filter-content/gutenberg/index.js"
/*!********************************************************************************!*\
  !*** ./assets/src/bulk-translate/components/filter-content/gutenberg/index.js ***!
  \********************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _filter_target_content__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../filter-target-content */ "./assets/src/bulk-translate/components/filter-target-content/index.js");
/* harmony import */ var _extarct_inner_content__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../extarct-inner-content */ "./assets/src/bulk-translate/components/filter-content/extarct-inner-content/index.js");
/* harmony import */ var _store_source_string__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../store-source-string */ "./assets/src/bulk-translate/components/store-source-string/index.js");
 ...
 */
const FilterGutenbergContent = async ({
  content,
  service,
  blockParseRules,
  postId,
  ...
  const getStringContent = async (content, contentKey, skipTags = []) => {
    ...
    if (filterHtmlContent) {
      let reactElement = (0,_filter_target_content__WEBPACK_IMPORTED_MODULE_1__["default"])({
        content,
        service,
        contentKey,
        skipTags
      });
      stringContent = await (0,_extarct_inner_content__WEBPACK_IMPORTED_MODULE_2__["default"])(reactElement);
      reactElement = null;
    }
    return stringContent;
  };
  const storeSourceString = async (contentKey, content, targetContent) => {
    (0,_store_source_string__WEBPACK_IMPORTED_MODULE_3__["default"])(postId, contentKey, content, targetContent, storeDispatch);
  };
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (FilterGutenbergContent);

/***/ },

/***/ "./assets/src/bulk-translate/components/filter-content/gutenberg/update-content.js"
/*!*****************************************************************************************!*\
  !*** ./assets/src/bulk-translate/components/filter-content/gutenberg/update-content.js ***!
  \*****************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
 ...
 * @returns {Object}
 */
const updateGutenbergContent = async ({
  source,
  lang,
  translatedContent,
  serviceProvider,
  ...
  const blockParseRules = (0,_redux_store_features_selectors__WEBPACK_IMPORTED_MODULE_0__.selectBlockParseRules)(_redux_store_store__WEBPACK_IMPORTED_MODULE_1__.store.getState());
  const sourceEntries = (0,_redux_store_features_selectors__WEBPACK_IMPORTED_MODULE_0__.selectSourceEntries)(_redux_store_store__WEBPACK_IMPORTED_MODULE_1__.store.getState(), postId);
  ...
  */
  ...
  const updateCustomBlockInnerHtml = key => {
    ...
    currentBlockKeys.forEach(item => {
      ...
      const translatedString = (0,_redux_store_features_selectors__WEBPACK_IMPORTED_MODULE_0__.selectTranslatedContent)(_redux_store_store__WEBPACK_IMPORTED_MODULE_1__.store.getState(), postId, item, lang, serviceProvider);
    ...
    let sortedTranslatedStrings = Object.entries(translatedStrings).sort((a, b) => b[0].split(/\s+/).length - a[0].split(/\s+/).length).reduce((acc, [k, v]) => {
      acc[k] = v;
      return acc;
    }, {});
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (updateGutenbergContent);
...
/* harmony export */ });
/* harmony import */ var _gutenberg__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./gutenberg */ "./assets/src/bulk-translate/components/filter-content/gutenberg/index.js");
/* harmony import */ var _gutenberg_update_content__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./gutenberg/update-content */ "./assets/src/bulk-translate/components/filter-content/gutenberg/update-content.js");
/* harmony import */ var _translate_provider__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../translate-provider */ "./assets/src/bulk-translate/components/translate-provider/index.js");
...
const filterContent = async ({
  ...
  postId,
  storeDispatch,
  blockParseRules = null,
  sourceLanguage = null
}) => {
  const filters = {
    'block': _gutenberg__WEBPACK_IMPORTED_MODULE_0__["default"]
  };
  const data = {
    content,
    service,
  ...
  data.filterHtmlContent = (0,_translate_provider__WEBPACK_IMPORTED_MODULE_2__["default"])({
    Service: service
  }).filterHtmlContent;
  if (blockParseRules) {
...
const updateFilterContent = async ({
  ...
  const updateContens = {
    'block': _gutenberg_update_content__WEBPACK_IMPORTED_MODULE_1__["default"]
  };
  ...
  return await updateContens[editorType]({
    source,
    lang,
    translatedContent,
    serviceProvider,
...
const bulkTranslateStore = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__.createSlice)({
  ...
  reducers: {
    ...
    updateServiceProvider: (state, action) => {
      if (['localAiTranslator', 'google', 'google_ai', 'openai_ai', 'openrouter_ai', 'deepl_ai'].includes(action.payload)) {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)("div", {
    ...
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsxs)("table", {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)("thead", {
        ...
        children: Object.keys(ServiceProviders).map(provider => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(_providers__WEBPACK_IMPORTED_MODULE_0__["default"], {
          ...props,
...
const SettingModal = props => {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.Fragment, {
    children: errorModal ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_components_error_modal_box__WEBPACK_IMPORTED_MODULE_6__["default"], {
      ...
      onClose: closeErrorModal,
      Title: "AutoML - AI Translation for WPML",
      prefix: prefix
...
const Providers = props => {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)("tr", {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)("td", {
      className: `${prefix}-provider-name`,
      ...
      children: ActiveService.ButtonDisabled ? ActiveService.ErrorMessage : /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("button", {
        id: btnId,
...
const StatusModal = ({
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    const translatePosts = async () => {
      ...
      (0,_bulk_translate__WEBPACK_IMPORTED_MODULE_1__.initBulkTranslate)(response.postKeys, response.nonce, storeDispatch, prefix, updateDestoryHandler);
    };
    translatePosts();
  }, []);
  ...
  return errorModal ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_components_error_modal_box__WEBPACK_IMPORTED_MODULE_5__["default"], {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)("h2", {
      ...
      className: `${prefix}-status-modal-close`,
      onClick: onModalClose,
      children: "\xD7"
    }), countInfo.totalPosts < 1 && countInfo.errorPosts < 1 && !isLoading ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)("p", {
      ...
      children: [isLoading && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)("div", {
      ...
      }), countInfo.totalPosts > 1 && progressBarVisibility && !isLoading ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.Fragment, {
      ...
      }) : countInfo.postsTranslated > 0 && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)("div", {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)("div", {
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)("span", {
            ...
            children: [(0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Posts Translated:', 'automl-ai-translation-for-wpml'), " "]
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)("span", {
            className: `${prefix}-post-translated-post`,
            children: countInfo.postsTranslated
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)("span", {
            className: `${prefix}-post-text`,
            children: [" ", (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('out of', 'automl-ai-translation-for-wpml'), " "]
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)("span", {
            className: `${prefix}-post-total`,
            children: countInfo.totalPosts
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)("span", {
            className: `${prefix}-post-total-text`,
            children: [" ", (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('posts translated', 'automl-ai-translation-for-wpml')]
          })]
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)("div", {
        ...
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)("div", {
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)("table", {
            ...
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)("thead", {
              ...
              children: [isLoading && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.Fragment, {
                children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)("tr", {
      ...
      }), countInfo.postsTranslated > 0 && !pendingPosts.length && !progressBarVisibility && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)("div", {
        className: `${prefix}-progress-footer`,
...
/* harmony import */ var _components_loop_callback__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/loop-callback */ "./assets/src/bulk-translate/components/loop-callback/index.js");
/* harmony import */ var _components_translate_provider_local_ai_local_ai_translate__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/translate-provider/local-ai/local-ai-translate */ "./assets/src/bulk-translate/components/translate-provider/local-ai/local-ai-translate.js");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! react/jsx-runtime */ "react/jsx-runtime");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__);
