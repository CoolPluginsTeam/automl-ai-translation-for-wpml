...
/* harmony import */ var _status_modal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./status-modal */ "./status-modal/index.js");
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/dist/react-redux.mjs");
/* harmony import */ var _redux_store_features_actions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./redux-store/features/actions */ "./redux-store/features/actions.js");
/* harmony import */ var _redux_store_features_selectors__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./redux-store/features/selectors */ "./redux-store/features/selectors.js");
/* harmony import */ var _components_translate_provider_local_ai_local_ai_translate__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/translate-provider/local-ai/local-ai-translate */ "./components/translate-provider/local-ai/local-ai-translate.js");
/* harmony import */ var _components_error_modal_box__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/error-modal-box */ "./components/error-modal-box/index.js");
/* harmony import */ var _setting_modal__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./setting-modal */ "./setting-modal/index.js");
...
/* harmony import */ var _components_notice__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/notice */ "./components/notice/index.js");
...
/* harmony export */ });
/* harmony import */ var _components_filter_content__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/filter-content */ "./components/filter-content/index.js");
/* harmony import */ var _helper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helper */ "./helper/index.js");
/* harmony import */ var _components_translate_provider_local_ai_local_ai_translate__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/translate-provider/local-ai/local-ai-translate */ "./components/translate-provider/local-ai/local-ai-translate.js");
/* harmony import */ var _redux_store_features_actions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./redux-store/features/actions */ "./redux-store/features/actions.js");
...
/* harmony import */ var _components_translate_provider__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/translate-provider */ "./components/translate-provider/index.js");
/* harmony import */ var _components_loop_callback__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/loop-callback */ "./components/loop-callback/index.js");
/* harmony import */ var _redux_store_features_selectors__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./redux-store/features/selectors */ "./redux-store/features/selectors.js");
...
const initBulkTranslate = async (postKeys = [], nonce, storeDispatch, prefix, updateDestoryHandler) => {
  ...
  const translatePost = async index => {
    ...
    const postContent = _redux_store_store__WEBPACK_IMPORTED_MODULE_4__.store.getState().parentPostsInfo[postId];
    if (postContent) {
      const {
        originalContent: {
          title,
...
const translateContent = async ({
  ...
  const providerDetails = (0,_components_translate_provider__WEBPACK_IMPORTED_MODULE_6__["default"])({
...
const updateContent = async ({
  ...
  const service = _redux_store_store__WEBPACK_IMPORTED_MODULE_4__.store.getState().serviceProvider;
...
const bulkTranslateEntries = async ({
  ...
  if (postKeys.length > 0) {
    ...
    const existsPostInPendingPosts = Object.keys(_redux_store_store__WEBPACK_IMPORTED_MODULE_4__.store.getState().translatePostInfo);
    ...
    const storeSourceContent = async (index, translatePostsCount) => {
      ...
      if (!sourceLanguage) {
        ...
        storeDispatch((0,_redux_store_features_actions__WEBPACK_IMPORTED_MODULE_3__.updateErrorPostsInfo)({
          postId,
          data: errorInfo
        }));
        storeDispatch((0,_redux_store_features_actions__WEBPACK_IMPORTED_MODULE_3__.updateCountInfo)({
          errorPosts: _redux_store_store__WEBPACK_IMPORTED_MODULE_4__.store.getState().countInfo.errorPosts + 1
        }));
        index++;
      ...
      if (languages && languages.length > 0) {
        ...
        storeDispatch((0,_redux_store_features_actions__WEBPACK_IMPORTED_MODULE_3__.updateTargetLanguages)({
          lang: targetLang
        }));
        const data = {
          content,
        ...
        const previousParentPostsInfo = _redux_store_store__WEBPACK_IMPORTED_MODULE_4__.store.getState().parentPostsInfo[postId];
        ...
        storeDispatch((0,_redux_store_features_actions__WEBPACK_IMPORTED_MODULE_3__.updateCountInfo)({
          totalPosts: _redux_store_store__WEBPACK_IMPORTED_MODULE_4__.store.getState().countInfo.totalPosts + targetLang.length
        }));
      } else {
        console.log(`All target languages for post ${postId} already exist. Skipping translation.`);
      }
    ...
    const translatePostsCount = _redux_store_store__WEBPACK_IMPORTED_MODULE_4__.store.getState().pendingPosts.length;
...
const translateStringsWithChromeAI = (strings, sourceLang, targetLang) => {
  ...
  return new Promise((resolve, reject) => {
    const translations = [];
    _components_translate_provider_local_ai_local_ai_translate__WEBPACK_IMPORTED_MODULE_2__["default"].Object({
...
/***/ "./components/copy-clipboard/index.js"
/*!********************************************!*\
  !*** ./components/copy-clipboard/index.js ***!
  \********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./components/error-modal-box/index.js"
/*!*********************************************!*\
  !*** ./components/error-modal-box/index.js ***!
  \*********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _copy_clipboard__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../copy-clipboard */ "./components/copy-clipboard/index.js");
...
/***/ "./components/filter-content/extarct-inner-content/index.js"
/*!******************************************************************!*\
  !*** ./components/filter-content/extarct-inner-content/index.js ***!
  \******************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./components/filter-content/gutenberg/index.js"
/*!******************************************************!*\
  !*** ./components/filter-content/gutenberg/index.js ***!
  \******************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _filter_target_content__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../filter-target-content */ "./components/filter-target-content/index.js");
/* harmony import */ var _extarct_inner_content__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../extarct-inner-content */ "./components/filter-content/extarct-inner-content/index.js");
/* harmony import */ var _store_source_string__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../store-source-string */ "./components/store-source-string/index.js");
...
/***/ "./components/filter-content/gutenberg/update-content.js"
/*!***************************************************************!*\
  !*** ./components/filter-content/gutenberg/update-content.js ***!
  \***************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _redux_store_features_selectors__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../redux-store/features/selectors */ "./redux-store/features/selectors.js");
...
/***/ "./components/filter-content/index.js"
/*!********************************************!*\
  !*** ./components/filter-content/index.js ***!
  \********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */ });
/* harmony import */ var _gutenberg__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./gutenberg */ "./components/filter-content/gutenberg/index.js");
/* harmony import */ var _gutenberg_update_content__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./gutenberg/update-content */ "./components/filter-content/gutenberg/update-content.js");
/* harmony import */ var _translate_provider__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../translate-provider */ "./components/translate-provider/index.js");
/* harmony import */ var _redux_store_features_selectors__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../redux-store/features/selectors */ "./redux-store/features/selectors.js");
/* harmony import */ var _redux_store_store__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../redux-store/store */ "./redux-store/store.js");
...
/***/ "./components/filter-target-content/index.js"
/*!***************************************************!*\
  !*** ./components/filter-target-content/index.js ***!
  \***************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./components/loop-callback/index.js"
/*!*******************************************!*\
  !*** ./components/loop-callback/index.js ***!
  \*******************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./components/store-source-string/index.js"
/*!*************************************************!*\
  !*** ./components/store-source-string/index.js ***!
  \*************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _redux_store_features_actions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../redux-store/features/actions */ "./redux-store/features/actions.js");
/* harmony import */ var _redux_store_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../redux-store/store */ "./redux-store/store.js");
...
/***/ "./components/store-translate-strings/index.js"
/*!*****************************************************!*\
  !*** ./components/store-translate-strings/index.js ***!
  \*****************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */ });
/* harmony import */ var _redux_store_features_actions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../redux-store/features/actions */ "./redux-store/features/actions.js");
/* harmony import */ var _update_translation_count__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../update-translation-count */ "./components/update-translation-count/index.js");
...
/***/ "./components/translate-provider/ai-services/index.js"
/*!************************************************************!*\
  !*** ./components/translate-provider/ai-services/index.js ***!
  \************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _helper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../helper/index */ "./helper/index.js");
/* harmony import */ var _store_translate_strings__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../store-translate-strings */ "./components/store-translate-strings/index.js");
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! .. */ "./components/translate-provider/index.js");
/* harmony import */ var _redux_store_features_actions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../redux-store/features/actions */ "./redux-store/features/actions.js");
/* harmony import */ var _bulk_translate__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../bulk-translate */ "./bulk-translate.js");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @wordpress/i18n */ "@wordpress/i18n");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _redux_store_features_selectors__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../redux-store/features/selectors */ "./redux-store/features/selectors.js");
...
/***/ "./components/translate-provider/index.js"
/*!************************************************!*\
  !*** ./components/translate-provider/index.js ***!
  \************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _local_ai__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./local-ai */ "./components/translate-provider/local-ai/index.js");
/* harmony import */ var _ai_services__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ai-services */ "./components/translate-provider/ai-services/index.js");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @wordpress/i18n */ "@wordpress/i18n");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__);
...
/***/ "./components/translate-provider/local-ai/index.js"
/*!*********************************************************!*\
  !*** ./components/translate-provider/local-ai/index.js ***!
  \*********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _local_ai_translate__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./local-ai-translate */ "./components/translate-provider/local-ai/local-ai-translate.js");
/* harmony import */ var _redux_store_features_actions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../redux-store/features/actions */ "./redux-store/features/actions.js");
/* harmony import */ var _redux_store_features_selectors__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../redux-store/features/selectors */ "./redux-store/features/selectors.js");
...
/* harmony import */ var _store_translate_strings__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../store-translate-strings */ "./components/store-translate-strings/index.js");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @wordpress/i18n */ "@wordpress/i18n");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _helper_index__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../helper/index */ "./helper/index.js");
...
/***/ "./components/translate-provider/local-ai/local-ai-translate.js"
/*!**********************************************************************!*\
  !*** ./components/translate-provider/local-ai/local-ai-translate.js ***!
  \**********************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./components/update-translation-count/index.js"
/*!******************************************************!*\
  !*** ./components/update-translation-count/index.js ***!
  \******************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _redux_store_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../redux-store/store */ "./redux-store/store.js");
/* harmony import */ var _redux_store_features_selectors__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../redux-store/features/selectors */ "./redux-store/features/selectors.js");
/* harmony import */ var _helper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../helper */ "./helper/index.js");
...
/***/ "./redux-store/features/actions.js"
/*!*****************************************!*\
  !*** ./redux-store/features/actions.js ***!
  \*****************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./redux-store/features/selectors.js"
/*!*******************************************!*\
  !*** ./redux-store/features/selectors.js ***!
  \*******************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */ });
/* harmony import */ var _reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @reduxjs/toolkit */ "./node_modules/@reduxjs/toolkit/dist/redux-toolkit.modern.mjs");
/* harmony import */ var _features_actions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./features/actions */ "./redux-store/features/actions.js");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _providers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./providers */ "./setting-modal/providers.js");
/* harmony import */ var _components_translate_provider__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/translate-provider */ "./components/translate-provider/index.js");
...
/* harmony import */ var _header__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./header */ "./setting-modal/header.js");
/* harmony import */ var _body__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./body */ "./setting-modal/body.js");
/* harmony import */ var _footer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./footer */ "./setting-modal/footer.js");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @wordpress/i18n */ "@wordpress/i18n");
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _components_error_modal_box__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/error-modal-box */ "./components/error-modal-box/index.js");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _components_translate_provider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/translate-provider */ "./components/translate-provider/index.js");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react/jsx-runtime */ "react/jsx-runtime");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _bulk_translate__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../bulk-translate */ "./bulk-translate.js");
...
/* harmony import */ var _components_error_modal_box__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/error-modal-box */ "./components/error-modal-box/index.js");
/* harmony import */ var _components_translate_provider_ai_services__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/translate-provider/ai-services */ "./components/translate-provider/ai-services/index.js");
/* harmony import */ var _redux_store_store__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../redux-store/store */ "./redux-store/store.js");
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    const translateContent = async () => {
      ...
      if (isStringTranslationPage) {
        ...
        } = await Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ../bulk-translate */ "./bulk-translate.js"));
...
/* harmony import */ var _components_loop_callback__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/loop-callback */ "./components/loop-callback/index.js");
/* harmony import */ var _components_translate_provider_local_ai_local_ai_translate__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/translate-provider/local-ai/local-ai-translate */ "./components/translate-provider/local-ai/local-ai-translate.js");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! react/jsx-runtime */ "react/jsx-runtime");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__);
