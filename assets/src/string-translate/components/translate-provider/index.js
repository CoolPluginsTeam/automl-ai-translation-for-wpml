...
export default (props) => {
    ...
    const Services = {
        localAiTranslator: {
            ...
            ErrorMessage: props.localAiTranslatorButtonDisabled ? <div className={`${prefix}-provider-error button button-primary`} onClick={() => openErrorModalHandler(props.localAiTranslatorButtonDisabled)}> {__('View Error', 'automl-ai-translation-for-wpml')}</div> : <></>,
            Logo: 'chrome.png',
